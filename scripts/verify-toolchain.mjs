...
assert.match(buildWorkflow, /packages: write/);
assert.match(buildWorkflow, /registry: ghcr\.io/);
assert.match(buildWorkflow, /ghcr\.io\/flamevip\/cloudflare-scan-mvp-agent/);
assert.match(buildWorkflow, /password: \$\{\{ secrets\.GITHUB_TOKEN \}\}/);
